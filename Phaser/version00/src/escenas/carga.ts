...
export default class Carga extends Phaser.Scene 
{
  ...
  cargaAssets() {
      ...
      this.load.image(Constantes.PLATAFORMAMOVIL.ID, "imagenes/objetos/platformamovil.png");
      ...
      this.load.image(Constantes.CONTROL.IZQUIERDA,"imagenes/control/controlSalto.png");
