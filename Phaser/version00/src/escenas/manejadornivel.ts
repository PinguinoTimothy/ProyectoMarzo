...
this.objetofinalColision.active = false;
    ...
    creaPlataformasMoviles(): void{
        this.plataformasMovilesH = new PlataformasMoviles(this, Constantes.MAPAS.PLATAFORMASMOVILES, Constantes.PLATAFORMAMOVIL.ID, Constantes.PLATAFORMAMOVIL.VELOCIDAD, true);

        this.plataformasMovilesV = new PlataformasMoviles(this, Constantes.MAPAS.PLATAFORMASMOVILES, Constantes.PLATAFORMAMOVIL.ID, Constantes.PLATAFORMAMOVIL.VELOCIDAD, false);
